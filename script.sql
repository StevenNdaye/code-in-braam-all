...
-- -----------------------------------------------------
DROP TABLE IF EXISTS movies.customer;
...
-- -----------------------------------------------------
-- Table movies.customer_order
-- -----------------------------------------------------
DROP TABLE IF EXISTS movies.customer_order;

CREATE TABLE IF NOT EXISTS movies.customer_order (
  id                  INT UNSIGNED  NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS movies.category;
...
-- -----------------------------------------------------
-- Table movies.product
-- -----------------------------------------------------
DROP TABLE IF EXISTS movies.product;

CREATE TABLE IF NOT EXISTS movies.product (
  id          INT UNSIGNED     NOT NULL AUTO_INCREMENT,
  name        VARCHAR(45)      NOT NULL,
...
-- -----------------------------------------------------
-- Table movies.ordered_product
-- -----------------------------------------------------
DROP TABLE IF EXISTS movies.ordered_product;

CREATE TABLE IF NOT EXISTS movies.ordered_product (
  ...
  REFERENCES movies.customer_order (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_ordered_product_product
  FOREIGN KEY (product_id)
  REFERENCES movies.product (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
  ENGINE = InnoDB;
